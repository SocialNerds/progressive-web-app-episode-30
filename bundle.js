...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.loadStarWars = function () {
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;

      fetch('http://www.omdbapi.com/?s=star%20wars&page=' + page + '&apikey=' + API_KEY).then(function (res) {
        return res.json();
      }).then(function (json) {
        return _this.setState({ movies: json.Search });
      });
    };

    _this.renderMovies = function () {
      return _this.state.movies.map(function (item) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement('img', { src: item.Poster })
        );
      });
    };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { href: '#', onClick: function onClick(e) {
              e.preventDefault();_this2.loadStarWars(1);
            } },
          'Page 1'
        ),
        _react2.default.createElement(
          'a',
          { href: '#', onClick: function onClick(e) {
              e.preventDefault();_this2.loadStarWars(2);
            } },
          'Page 2'
        ),
        _react2.default.createElement(
          'a',
          { href: '#', onClick: function onClick(e) {
              e.preventDefault();_this2.loadStarWars(3);
            } },
          'Page 3'
        )
      );
